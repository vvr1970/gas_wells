...
func NewWellHandler(s *service.WellService, logger *slog.Logger) *WellHandler {
	// Загружаем все шаблоны при инициализации
	tmpl := template.Must(template.ParseGlob("web/templates/*.html"))
	tmpl = template.Must(tmpl.ParseGlob("web/templates/wells/*.html"))
